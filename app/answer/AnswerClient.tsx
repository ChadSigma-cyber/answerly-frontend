  ...
  return (
    ...
    <div className="relative min-h-screen modern-texture-bg text-gray-200 flex flex-col overflow-hidden">
      ...
      <main className="flex-grow flex items-center justify-center px-6">
        <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-3 -mt-35 md:-mt-2">
      ...
      <footer className="py-6 text-center text-sm text-gray-400 mb-25 md:mb-0">
