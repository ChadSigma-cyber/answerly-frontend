    ...
    <div className="relative min-h-screen flex flex-col justify-between modern-texture-bg text-gray-200 overflow-hidden">
      ...
      <header className="absolute top-0 left-0 right-0 z-10 p-6 md:p-8">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-emerald-500">Answerly</span>
          </div>
      ...
      <main className="flex-grow flex items-center justify-center text-center px-4">
        <div className="space-y-8 max-w-4xl">
          ...
          <div className="pt-6">
            <Link href="/ask">
            <button className="group relative inline-flex items-center justify-center bg-emerald-500 text-black font-bold py-5 px-12 rounded-full text-xl shadow-[0_4px_10px_rgba(16,185,129,0.2),0_0_0_1px_rgba(16,185,129,0.5)] hover:shadow-[0_6px_15px_rgba(16,185,129,0.3)] transition-all duration-300 transform hover:-translate-y-1">
